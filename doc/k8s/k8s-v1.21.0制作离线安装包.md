...
#下载kubelet-1.21.0 kubeadm-1.21.0 kubectl-1.21.0离线安装包
yum install --downloadonly --downloaddir=/root/k8s  kubelet-1.21.0 kubeadm-1.21.0 kubectl-1.21.0
...
kubeadm init \
  --apiserver-advertise-address=192.168.68.149 \
...
docker save registry.aliyuncs.com/google_containers/kube-apiserver:v1.21.0  -o kube-apiserver_v1.21.0.tar
docker save registry.aliyuncs.com/google_containers/kube-proxy:v1.21.0  -o kube-proxy_v1.21.0.tar
docker save registry.aliyuncs.com/google_containers/kube-controller-manager:v1.21.0 -o kube-controller-manager_v1.21.0.tar
docker save registry.aliyuncs.com/google_containers/kube-scheduler:v1.21.0  -o kube-scheduler_v1.21.0.tar
...
docker load < ./images/kube-apiserver_v1.21.0.tar
docker load < ./images/kube-proxy_v1.21.0.tar
docker load < ./images/kube-controller-manager_v1.21.0.tar
docker load < ./images/kube-scheduler_v1.21.0.tar
